...
4. **Verify**
   ...
   - Example: `GET http://localhost:8080/transactions?page=0&size=10`
   - Dashboard: `GET http://localhost:8080/dashboard/monthly`
   - Category summary: `GET http://localhost:8080/summary/categories?period=monthly`
